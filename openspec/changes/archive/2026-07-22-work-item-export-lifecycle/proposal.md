...
- Replace README scaffold with operator docs: env vars, `export` usage, minimum Kibana data view + Discover saved search (R1-FR-KIB-2)
...
| Full dashboards (status/severity charts, R1-FR-KIB-3–6) | Minimum Discover saved search first; charts documented as follow-up |
...
- `kibana-reporting`: README SHALL document minimum manual data view + Discover saved search setup (R1-FR-KIB-9)
